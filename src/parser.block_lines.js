...
const annotationParsers = {
  ...
  '@apiauthcookie': require('./annotations/api_param').construct('authCookie'),
  ...
  '@apiparsecfg': require('./annotations/api_parse_cfg'),
  ...
  '@apistatuscode': require('./annotations/api_status_code'),
  '@apisubgroup': require('./annotations/api_sub_group'),
  '@apisuccesscontenttype': require('./annotations/api_success_content_type'),
  ...
  '@apicookievalue': require('./annotations/api_param_value').construct('cookieValue'),
