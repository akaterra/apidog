...
function peg$parse(input, options) {
  ...
  const peg$e13 = peg$literalExpectation("v", false);
  const peg$e14 = peg$otherExpectation("whitespace");
  const peg$e15 = peg$classExpectation([" ", "\t"], false, false, false);

  function peg$f0(name, title) {    return { name, title }  }
  function peg$f1(name) {    return { name, title: null }  }
  function peg$f2(title) {    return title.join('')  }
