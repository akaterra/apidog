...
function peg$parse(input, options) {
  ...
  var peg$f8 = function(sequence) { return sequence};
  ...
  var peg$f16 = function() { return "\x0B"};
  ...
  function peg$parseTypeNameCharacter() {
    var s0, s1, s2;
