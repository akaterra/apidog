...
function peg$parse(input, options) {
  ...
  function peg$f0(group, type, value, description) {    return { group, type, value, description }  }
  function peg$f1(name) {    return { name }  }
  function peg$f2(head) {    return head.join('')  }
  function peg$f3(char) {    return char  }
  function peg$f4(name) {    return { name }  }
  function peg$f5(head) {    return head.join('') || null  }
  function peg$f6(head) {    return head.join('')  }
  ...
  function peg$f13() {    return "\b"  }
  function peg$f14() {    return "\f"  }
  function peg$f15() {    return "\n"  }
  function peg$f16() {    return "\r"  }
  function peg$f17() {    return "\t"  }
  function peg$f18() {    return "\x0B"  }
