...
function peg$parse(input, options) {
  ...
  var peg$f1 = function(type) { return { type, description: null } };
  var peg$f2 = function(description) { return { type: null, description } };
  var peg$f3 = function(name) { return { name } };
  var peg$f4 = function(description) { return description.join('') };
