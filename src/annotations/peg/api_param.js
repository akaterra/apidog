...
function peg$parse(input, options) {
  ...
  var peg$f3 = function(name, list, constraints) { return { name, list: list.length, ...constraints } };
  var peg$f4 = function(list, constraints) { return { name: null, list: list.length, ...constraints } };
